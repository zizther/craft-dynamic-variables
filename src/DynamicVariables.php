...
namespace zizther\dynamicvariables;

use zizther\dynamicvariables\twigextensions\DynamicVariablesTwigExtension;
 ...
 *
 */
class DynamicVariables extends Plugin
{
    // Static Properties
    // =========================================================================
    ...
    public function init()
    {
        ...
        Craft::$app->view->registerTwigExtension(new DynamicVariablesTwigExtension());
